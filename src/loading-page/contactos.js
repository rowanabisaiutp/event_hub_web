...
import './Css/contacto.css';  // Asegúrate de que la ruta sea correcta
        ...
        <div>
            ...
            <div className="container-contacto">
                <div className="row justify-content-center">
                    <div className="col-6 col-sm-3 info">
                        ...
                        <p className="info-texto2">Si deseas consultar mayor información sobre nuestros servicios o tienes dudas al respecto, no dudes en contactarnos y uno de nuestros asesores se pondrá en contacto contigo a la brevedad.</p>
                        ...
                        <div className="formulario-contacto">
                            ...
                            <form>
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-group col-6 col-sm-6">
                                        <label htmlFor="horario-contacto" className="required-label">Horario de Contacto</label>
                                    ...
                                    <div className="form-group col-6 col-sm-6">
                                        ...
                                        <select id="consulta" className="form-control" required>
                                            <option value="">Selecciona una opción</option>
                                            <option value="servicio">Información sobre el servicio</option>
                                            <option value="feedback">Feedback y Sugerencias</option>
                                            <option value="reclamaciones">Reclamaciones</option>
                                            <option value="soporte">Soporte técnico</option>
                                            <option value="reservas">Reserva de Boletos</option>
                                            <option value="precios">Precios</option>
                                            <option value="membresias">Membresías y Paquetes para Organizador</option>
                                            <option value="eventos">Requisitos y Procedimientos para Registrar mi evento</option>
                                    ...
                                    <div className="form-group col-6 col-sm-6 ">
                                        ...
                                        <select name="canal" className="form-control">
                                            <option value="">Selecciona una opción</option>
            ...
            <footer>
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="container-redes col-6 col-sm-3">
                            ...
                            <div className="social-icons">
                                <a className="Facebook" href="#" target="_blank"><FontAwesomeIcon icon={faFacebookF} /></a>
                                <a className="Instagram" href="#" target="_blank"><FontAwesomeIcon icon={faInstagram} /></a>
                                <a className="WhatsApp" href="#" target="_blank"><FontAwesomeIcon icon={faWhatsapp} /></a>
                                <a className="Youtube" href="#" target="_blank"><FontAwesomeIcon icon={faYoutube} /></a>
                            </div>
                ...
                <div className="footer-bottom">
                    <div className="container-info">
                        <p>&copy; 2023 Digital Event Hub. Todos los derechos reservados.</p>
                    </div>
                </div>
            </footer>
        </div>
